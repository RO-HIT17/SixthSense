Visually Challenged Navigator (Real Time + On Command)
- Assist People in navigation with directions/alerts obstacles
- Voice Commands/Conversational
- Using the mobile camera we just alert the user of whats happeing around him through airpods & Help him convert the world around him to text (text,documents,currency,scenries,people) etc
Complete Automation of various task and apps through voice command
